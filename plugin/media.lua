...
if text then
if text:match("^فيزرزرزبسبوك (.*)$") or text:match("^fb (.*)$") or text:match("^اننبزبنستا (.*)$") or text:match("^insta (.*)$") or text:match("^تييزيزيزكتوك (.*)$") or text:match("^سابززبىوند (.*)$")  then
...
local link = text:match("^فنبنبننيزيسبوك (.*)$") or text:match("^fb (.*)$") or text:match("^انزبزبزبزستا (.*)$") or text:match("^inزبنبنsta (.*)$") or text:match("^تيزينبينكتوك (.*)$") or text:match("^ساينبننوند (.*)$")
...
if text == "فينيينيظظسبوك" or text == "انبنبنبظيستا" then
