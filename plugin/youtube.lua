...
local json = json:decode(http.request("https://www.ava-tar.online/api/youtube/s/index.php?search="..URL.escape(search)..""))
local datar = {data = {{text = "قناه السورس" , url = 'https://t.me/source_av'}}}
for i = 1,5 do
...
local se = https.request("https://www.ava-tar.online/api/youtube/s1/index.php?search="..URL.escape(text))
...
local json = request("https://www.ava-tar.online/api/translate/index.php?to=ar&text="..URL.escape(Text))
...
local json = request("https://www.ava-tar.online/api/translate/index.php?to=en&text="..URL.escape(Text))
send(msg_chat_id,msg_id,json,"html",true)
end
...
{{text = ' قناه السورس', url = "https://t.me/source_av"}},
}
}
return send(msg_chat_id,msg_id, [[*
